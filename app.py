...
if 'board_data' not in st.session_state:
    st.session_state.board_data = pd.DataFrame(
        columns=['ระเบียบวาระ', 'มติที่ประชุม', 'ความก้าวหน้าของการดำเนินงาน', 'ผลการดำเนินงาน', 'ผู้รับผิดชอบ', 'วันที่ส่งมอบ', 'สถานะ'],
        data=[
            ['ระเบียบวาระ', 'ข้อสั่งการ...', 'ฝ่าย...', 'รอการรายงาน...', '-', 'รอดำเนินการ']
        ]
    )
